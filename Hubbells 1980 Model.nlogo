...
252
295
Number of extinct species in the local community
extinct-species
17
1
11
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy ticks richness1"
...
206
246
Local community initial species richness
local-richness
17
1
11
...
1. **JL**: Decides the local community size (K). To change the JL use the slider W2. JL = (W2 + 1)<sup>2</sup>
...
Hubbell, S. P. (1980). Seed Predation and the Coexistence of Tree Species in Tropical Forests. _Oikos_, **35**(2), 214.

## CREDITS AND REFERENCES

* Punchi-Manage, R. (2023p).  NetLogo Hubbell's (1980) Janzen-Connell Model. http://modelingcommons.org/browse/one_model/7263
https://ccl.northwestern.edu/netlogo/models/community/Dewdney%202000%20Model
